/**
 * Rendez-vous Page - Appointment management with calendar
 */
...
const RendezVous = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingRdv) {
                await rendezVousAPI.update(editingRdv.id, data);
            } else {
                        ...
                        <div className="calendar-days">
                            {getDaysInMonth(selectedDate).map((day, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`calendar-day ${!day ? 'empty' : ''} ${isToday ? 'today' : ''} ${isPast ? 'past' : ''} ${dayRdv.length > 0 ? 'has-rdv' : ''}`}
                                    >
                                        {day && (
                                            <>
